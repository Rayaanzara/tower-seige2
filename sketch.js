...
function setup(){
   ...
   box1 = new Box(330,280,30,40);
   box2 = new Box(360,280,30,40);
   box3 = new Box(390,280,30,40);
   box4 = new Box(420,280,30,40);
   box5 = new Box(450,280,30,40);
   box6 = new Box(360,260,30,40);
   box7 = new Box(390,260,30,40);
   box8 = new Box(420,260,30,40);
   box9 = new Box(390,240,30,40);
